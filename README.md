...
**This project is only compatible with the initial release version of Pokemon Go. As of Pokémon GO v1.1.0 (released on July 30th) Niantic has implemented SSL pinning, rendering this method useless on any newer versions.**
